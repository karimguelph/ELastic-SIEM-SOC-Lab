...
- **Attack Simulation**: Ran Nmap and Hydra tests to generate telemetry.
- **Custom Rules**: Created detection rules for Nmap and Hydra activities.
- **Alert Automation**: Configured alerts for email and webhook notifications.
- **Data Visualization**: Built dashboards in Kibana for event analysis.

---

### Tools & Skills

- **Tools**: Elastic Stack, Nmap, Hydra, Webhook.site, Kali Linux.
- **Skills**: SOC workflows, detection rules, alert configuration, data visualization.
